    ...
    # ---- Section 1: Who Are We Helping ------------------------------------
    {
        ...
        "questions": [
            q(
                ...
                "short_text",
                True,
                helper_text="As it appears on official documents — we reuse it to fill"
            ...
            q(
                ...
                "First name of the person you care for",
                "short_text",
                True,
            ...
            q(
                ...
                "[recipient name]'s street address",
                "short_text",
                True,
...
def build_schema() -> dict:
    ...
    return {
        ...
        "name_field": "recipient.first_name",
